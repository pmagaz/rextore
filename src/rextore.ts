...
export const createRextore = <T>(initialState: T, rootReducer: Function): Rextore => {
  ...
  const dispatcher$ = createDispatcher(store$, rootReducer)
  ...
  return { dispatch, getState, ...selectors }
